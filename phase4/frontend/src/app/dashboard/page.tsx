...
import { LogOut, CheckCircle2, Circle, Trash2, Plus, MessageSquare } from "lucide-react";
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-6">
                <div className="flex justify-between items-center mb-8 border-b pb-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link href="/chat" className="text-indigo-600 hover:text-indigo-800 flex items-center gap-1 transition font-medium">
